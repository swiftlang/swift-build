...
@Suite fileprivate struct ModuleVerifierFrameworkTests: CoreBasedTests {
    ...
    fileprivate func assert(
        _ frameworkInstance: ModuleVerifierFramework,
        path: Path,
        inSDK: Bool,
        framework: String,
        name: String,
        ...
        #expect(
            frameworkInstance.directory == path,
            "path is \(frameworkInstance.directory), should be \(path)"
        )

        #expect(
            frameworkInstance.inSDK == inSDK,
            "inSDK is \(frameworkInstance.inSDK), should be \(inSDK)"
        )

        #expect(
            frameworkInstance.framework == framework,
        ...
        if hasPrivateModuleMap {
            #expect(
                frameworkInstance.privateModuleMap != nil,
        ...
        #expect(
            frameworkInstance.additionalModuleMaps.count == additionalModuleMapsCount,
        ...
        #expect(
            frameworkInstance.additionalModuleFiles.count == additionalModuleFilesCount,
    ...
    func badFramework() async throws {
        ...
        try fs.write(
            frameworkPath.join("Headers/BadHeader.h"),
            contents: """
        ...
        try fs.write(
            frameworkPath.join("Modules/module.modulemap"),
            contents: """
        ...
        try fs.write(
            frameworkPath.join("Modules/additionalFile"),
            contents: """
                framework module BadFramework {
                    umbrella "Headers"
                    export *
    ...
    func newFramework() async throws {
        ...
        try fs.createDirectory(frameworkPath.join("Modules"), recursive: true)
        try fs.write(
            frameworkPath.join("Headers/NewHeader.h"),
            contents: """
                #if THIS_MACRO_IS_NOT_DEFINED
                int x = 1;
                #endif
    ...
    func perfectFramework() async throws {
        ...
        try fs.createDirectory(frameworkPath.join("Modules"), recursive: true)
        try fs.write(
            frameworkPath.join("Headers/PerfectFramework.h"),
            contents: """
                #import <PerfectFramework/PerfectHeader.h>
                """
        )
        try fs.write(
            frameworkPath.join("Headers/PerfectHeader.h"),
            contents: """
                void perfect_function( int );
                """
        )
        try fs.write(
            frameworkPath.join("PrivateHeaders/PerfectFramework_Private.h"),
            contents: """
                #import <PerfectFramework/PerfectPrivateHeader.h>
                """
        )
        try fs.write(
            frameworkPath.join("PrivateHeaders/PerfectPrivateHeader.h"),
            contents: """
        ...
        try fs.write(
            frameworkPath.join("Modules/module.private.modulemap"),
            contents: """
    ...
    func privateOnlyPublicModuleFramework() async throws {
        ...
        try fs.createDirectory(frameworkPath.join("Modules"), recursive: true)
        try fs.write(
            frameworkPath.join("PrivateHeaders/PrivateOnlyPublicModule_Private.h"),
            contents: """
                #import <PrivateOnlyPublicModule/PrivateHeader.h>
                """
        )
        try fs.write(
            frameworkPath.join("PrivateHeaders/PrivateHeader.h"),
            contents: """
                void perfect_private_function( int );
                """
        )
    ...
    func privateOnlyPublicPrivateModule() async throws {
        ...
        try fs.createDirectory(frameworkPath.join("Modules"), recursive: true)
        try fs.write(
            frameworkPath.join("PrivateHeaders/PrivateOnlyPublicPrivateModule_Private.h"),
            contents: """
                #import <PrivateOnlyPublicModule/PrivateHeader.h>
                """
        )
    ...
    func headerIncludes() async throws {
        ...
        try fs.write(
            frameworkPath.join("PrivateHeaders/Modular.h"),
            contents: """
                #import <PerfectFramework/PerfectPrivateHeader.h>
                """
        )
        try fs.write(
            frameworkPath.join("PrivateHeaders/Private.h"),
            contents: """
                void perfect_private_function( int );
                """
        )
        try fs.write(
            frameworkPath.join("PrivateHeaders/PrivateTextual.h"),
            contents: """
                void perfect_private_function( int );
                """
        )
        try fs.write(
            frameworkPath.join("PrivateHeaders/Excluded.h"),
            contents: """
                void perfect_private_function( int );
                """
        )
