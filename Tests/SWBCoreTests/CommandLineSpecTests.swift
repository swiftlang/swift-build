...
@Suite fileprivate struct CommandLineSpecTests: CoreBasedTests {
    ...
    func swiftTaskConstruction() async throws {
        ...
        table.push(BuiltinMacros.PER_SLICE_OBJECT_FILE_DIR, BuiltinMacros.namespace.parseString(Path.root.join("tmp/output/obj-normal/x86_64").str))
        table.push(BuiltinMacros.PER_SLICE_MODULE_FILE_DIR, BuiltinMacros.namespace.parseString(Path.root.join("tmp/output/obj-normal/x86_64").str))
        ...
        table.push(BuiltinMacros.SWIFT_RESPONSE_FILE_PATH,  core.specRegistry.internalMacroNamespace.parseString("$(PER_SLICE_OBJECT_FILE_DIR)/$(TARGET_NAME).SwiftFileList"))
    ...
    func swiftTaskConstruction_integratedDriver() async throws {
        ...
        table.push(BuiltinMacros.PER_SLICE_OBJECT_FILE_DIR, BuiltinMacros.namespace.parseString("/tmp/output/obj-normal/x86_64"))
        table.push(BuiltinMacros.PER_SLICE_MODULE_FILE_DIR, BuiltinMacros.namespace.parseString("/tmp/output/obj-normal/x86_64"))
        table.push(BuiltinMacros.ENABLE_DEFAULT_SEARCH_PATHS, literal: true)
        ...
        do {
            ...
            task.checkCommandLine(["builtin-Swift-Compilation-Requirements", "--", swiftCompilerPath.str, "-disable-bridging-pch", "-module-name", "App1", "-Xfrontend", "-disable-all-autolinking", "@/tmp/output/obj-normal/x86_64/App1.SwiftFileList", "-target", "x86_64-apple-macos10.11", "-Xfrontend", "-no-serialize-debugging-options", "-F", "/tmp/output/sym", "-F", "ProductTypeFwkPath", "-c", "-j\(SwiftCompilerSpec.parallelismLevel)", "-disable-batch-mode", "-output-file-map", "/tmp/output/obj-normal/x86_64/App1-OutputFileMap.json", "-save-temps", "-no-color-diagnostics", "-emit-dependencies", "-emit-module", "-emit-module-path", "/tmp/output/obj-normal/x86_64/App1.swiftmodule", "-serialize-diagnostics", "-Xcc", "-I/tmp/output/obj/DerivedFiles-normal/x86_64", "-Xcc", "-I/tmp/output/obj/DerivedFiles/x86_64", "-Xcc", "-I/tmp/output/obj/DerivedFiles", "-emit-objc-header", "-emit-objc-header-path", "/tmp/output/obj-normal/x86_64/App1-Swift.h", "-working-directory", "/tmp/src", "-experimental-emit-module-separately", "-disable-cmo"])
    ...
    func singleFileSwiftTaskConstruction() async throws {
        ...
        table.push(BuiltinMacros.PER_SLICE_OBJECT_FILE_DIR, literal: Path.root.join("build/objects").str)
        table.push(BuiltinMacros.CURRENT_ARCH, literal: "x86_64")
        table.push(BuiltinMacros.CURRENT_SLICE, core.specRegistry.internalMacroNamespace.parseString("$(CURRENT_ARCH)"))
        table.push(BuiltinMacros.CURRENT_SLICE_UNVERSIONED, core.specRegistry.internalMacroNamespace.parseString("$(CURRENT_SLICE)"))
        table.push(BuiltinMacros.SWIFT_PLATFORM_TARGET_PREFIX, literal: "macos")
    ...
    func clangCompileTaskConstruction() async throws {
        ...
        table.push(BuiltinMacros.PER_SLICE_OBJECT_FILE_DIR, BuiltinMacros.namespace.parseString("$(OBJECT_FILE_DIR)-$(CURRENT_VARIANT)/$(CURRENT_ARCH)"))
        table.push(BuiltinMacros.ENABLE_DEFAULT_SEARCH_PATHS, literal: true)
    ...
    func linkerTaskConstruction() async throws {
        ...
        #expect(task.execDescription == "Link output (x86_64)")
        // FIXME: This still has a lot of issues.
        task.checkCommandLine([
            core.hostOperatingSystem.imageFormat.executableName(basename: "clang"), "-Xlinker", "-no_warn_duplicate_libraries", "-Xlinker", "-rpath", "-Xlinker", "rpath1", "-nostdlib",
