...
fileprivate struct BuildServiceTests: CoreBasedTests {
    ...
    @Test(.requireSDKs(.macOS, .iOS, .tvOS, .watchOS, .xrOS, .driverKit),
        ...
        .init(triple: "arm64-apple-ios17.0-macabi", platformName: "macosx", buildProductsDirectorySuffix: "-maccatalyst", sdkVariant: "iosmac", deploymentTargetSettingName: "IPHONEOS_DEPLOYMENT_TARGET", deploymentTarget: "17.0"),
