...
@Suite fileprivate struct MacroConditionExpressionTests {
    ...
    init() async throws {
        ...
        table.push(namespace.lookupMacroDeclaration("IS_TRUE") as! BooleanMacroDeclaration, literal: true)
        table.push(namespace.lookupMacroDeclaration("IS_FALSE") as! BooleanMacroDeclaration, literal: false)
        table.push(namespace.lookupMacroDeclaration("FOO") as! StringMacroDeclaration, literal: "foo")
        table.push(namespace.lookupMacroDeclaration("BAR") as! StringMacroDeclaration, literal: "bar")
        table.push(namespace.lookupMacroDeclaration("BAZ") as! StringMacroDeclaration, literal: "baz")
        table.push(namespace.lookupMacroDeclaration("QUUX") as! StringMacroDeclaration, literal: "quux")
        table.push(namespace.lookupMacroDeclaration("FOOBAR") as! StringMacroDeclaration, namespace.parseString("$(FOO)$(BAR)"))
        table.push(namespace.lookupMacroDeclaration("FOO_BAR") as! StringMacroDeclaration, namespace.parseString("$(FOO) $(BAR)"))
        table.push(namespace.lookupMacroDeclaration("EMPTY") as! StringMacroDeclaration, namespace.parseString(""))
