...
public final class BuiltinMacros {
    ...
    public static let DOCC_EXTRACT_PROJECT_DOCUMENTATION = BuiltinMacros.declareBooleanMacro("DOCC_EXTRACT_PROJECT_DOCUMENTATION")
    ...
    private static let allBuiltinMacros = [
        ...
        DOCC_EXTRACT_PROJECT_DOCUMENTATION,
