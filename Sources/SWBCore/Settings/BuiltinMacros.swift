...
public final class BuiltinMacros {
    ...
    public static let _CLANG_EXPLICIT_MODULES_ALLOW_CXX = BuiltinMacros.declareBooleanMacro("_CLANG_EXPLICIT_MODULES_ALLOW_CXX")
    ...
    private static let allBuiltinMacros = [
        ...
        _CLANG_EXPLICIT_MODULES_ALLOW_CXX,
