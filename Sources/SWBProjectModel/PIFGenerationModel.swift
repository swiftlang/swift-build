...
public enum PIF {
    ...
    public class BaseTarget {
        ...
        public func addDependency(on targetId: String, platformFilters: Set<PlatformFilter>) {
            addDependency(on: targetId, platformFilters: platformFilters, buildConfigurationFilters: [])
        }
    ...
    public class Target : BaseTarget {
        ...
        public func addDependency(on targetId: String, platformFilters: Set<PlatformFilter>, linkProduct: Bool) {
            addDependency(on: targetId, platformFilters: platformFilters, buildConfigurationFilters: [], linkProduct: linkProduct)
        }
        ...
        @discardableResult public func addLibrary(ref: FileReference, platformFilters: Set<PlatformFilter>, codeSignOnCopy: Bool = false, removeHeadersOnCopy: Bool = false) -> BuildFile {
            return addLibrary(ref: ref, platformFilters: platformFilters, buildConfigurationFilters: [], codeSignOnCopy: codeSignOnCopy, removeHeadersOnCopy: removeHeadersOnCopy)
        }
        ...
        @discardableResult public func addResourceFile(ref: FileReference, platformFilters: Set<PlatformFilter>, resourceRule: BuildFile.ResourceRule? = nil) -> BuildFile {
            return addResourceFile(ref: ref, platformFilters: platformFilters, buildConfigurationFilters: [], resourceRule: resourceRule)
        }
    ...
    public class BuildPhase {
        ...
        @_disfavoredOverload @discardableResult public func addBuildFile(fileRef: FileReference, platformFilters: Set<PlatformFilter> = [], codeSignOnCopy: Bool = false, removeHeadersOnCopy: Bool = false, generatedCodeVisibility: BuildFile.GeneratedCodeVisibility? = nil, resourceRule: BuildFile.ResourceRule? = nil) -> BuildFile {
            return addBuildFile(fileRef: fileRef, platformFilters: platformFilters, buildConfigurationFilters: [], codeSignOnCopy: codeSignOnCopy, removeHeadersOnCopy: removeHeadersOnCopy, generatedCodeVisibility: generatedCodeVisibility, resourceRule: resourceRule)
        }
        ...
        @_disfavoredOverload @discardableResult public func addBuildFile(productOf targetId: String, platformFilters: Set<PlatformFilter> = [], codeSignOnCopy: Bool = false) -> BuildFile {
            return addBuildFile(productOf: targetId, platformFilters: platformFilters, buildConfigurationFilters: [], codeSignOnCopy: codeSignOnCopy)
        }
    ...
    public class BuildFile {
        ...
        @_disfavoredOverload public convenience init(id: String, reference: FileReference, platformFilters: Set<PlatformFilter> = [], codeSignOnCopy: Bool = false, removeHeadersOnCopy: Bool = false) {
            self.init(id: id, reference: reference, platformFilters: platformFilters, buildConfigurationFilters: [], codeSignOnCopy: codeSignOnCopy, removeHeadersOnCopy: removeHeadersOnCopy)
        }
        ...
        @_disfavoredOverload public convenience init(id: String, targetId: String, platformFilters: Set<PlatformFilter> = [], codeSignOnCopy: Bool = false, removeHeadersOnCopy: Bool = false) {
            self.init(id: id, targetId: targetId, platformFilters: platformFilters, buildConfigurationFilters: [], codeSignOnCopy: codeSignOnCopy, removeHeadersOnCopy: removeHeadersOnCopy)
        }
    ...
    public struct BuildSettings: Sendable {
        ...
        public var SWIFT_REGISTERED_MODULE_DEPENDENCIES: [String]?
