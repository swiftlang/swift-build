...
final public class PrecompileClangModuleTaskAction: TaskAction, BuildValueValidatingTaskAction {
    ...
    override public func performTaskAction(
        ...
        do {
            ...
            try await TaskAction.spawn(commandLine: commandLine, environment: [:], workingDirectory: dependencyInfo.workingDirectory.str, dynamicExecutionDelegate: dynamicExecutionDelegate, clientDelegate: clientDelegate, processDelegate: delegate)
