    ...
    public override func performTaskAction(
        ...
        for input in options.inputs {
            ...
            if let compression = options.compression {
                ...
                do {
                    try await TaskAction.spawn(commandLine: tiffutilCommand, environment: task.environment.bindingsDictionary, workingDirectory: task.workingDirectory.str, dynamicExecutionDelegate: dynamicExecutionDelegate, clientDelegate: clientDelegate, processDelegate: processDelegate)
                } catch {
