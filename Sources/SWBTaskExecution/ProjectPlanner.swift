...
private extension BuildParameters {
    ...
    private static func runDestination(for platform: Platform) -> RunDestinationInfo {
        ...
        return RunDestinationInfo(buildTarget: .appleSDK(platform: platform.name, sdk: platform.name, sdkVariant: nil), targetArchitecture: targetArchitecture, supportedArchitectures: [targetArchitecture], disableOnlyActiveArch: false, hostTargetedPlatform: nil)
    }
}
